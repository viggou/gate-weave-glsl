...
`git clone https://github.com/viggou/gateweave-glsl.git`

2. Move both the .glsl and .xml files to your "shaders" folder
...
`/Library/Application Support/FilmLight/shaders`
